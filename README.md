About typescript-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typescript-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/Microsoft/TypeScript
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5845&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typescript-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typescript` can be installed with `conda`:
...
```
mamba install typescript
```

It is possible to list all of the versions of `typescript` available on your platform with `conda`:
...
```
mamba search typescript --channel conda-forge
```
...
mamba repoquery search typescript --channel conda-forge

# List packages depending on `typescript`:
mamba repoquery whoneeds typescript --channel conda-forge

# List dependencies of `typescript`:
mamba repoquery depends typescript --channel conda-forge
```
